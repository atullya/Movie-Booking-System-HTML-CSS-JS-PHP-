    ...
    <div id="wrapper">
        ...
        <div id="main-content">
            ...
            <form id="movieForm" enctype="multipart/form-data">
                <input type="text" value="Title" id="title" placeholder="Title" required><br>
                <input type="text" value="1hr" id="duration" placeholder="Duration" required><br>
                <input type="text" value="6:00" id="available_time" placeholder="Available Time (comma-separated)" required><br>
                <input type="text" value="Comic" id="genere" placeholder="Genre" required><br>
                <textarea id="description" placeholder="Description" required>hah</textarea><br>
                <input type="text" value="hah" id="director" placeholder="Director" required><br>
                <input type="text" value="hah" id="cast" placeholder="Cast" required><br>
                <input type="date" value="2024-01-01" id="releaseon" placeholder="Release Date" required><br>
