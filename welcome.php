...
<body>
  ...
  <section id="slider">
    <div class="slideshow-container">
      ...
      <div class="mySlides fade">
        <img src="Images/mona.png" style="width: 100%; object-fit:conver; height:500px;" />
      </div>
  ...
  <section id="hero">
    ...
    <!-- <footer>
      <div class="col1">
        ...
        <div class="col1-des">
          <li>
            Cine Nepal Cineplex is a multiplex that is fully equipped with
      ...
      <div class="col4">
        <div class="col4-upper">
          <p>Contact</p>
          <ul>
            <li>5th Floor, Cine Nepal Trade Center Newroad, Kathmandu</li>
            <li>info@CineNepal.com</li>
        ...
        <div class="col4-lower">
          ...
          <div class="connect">
            ...
            <div class="social">
              <div class="fb"><i class="fa-brands fa-facebook"></i>
                <p>Cine Nepal Cineplex</p>
              </div>
              <div class="insta"><i class="fa-brands fa-instagram"></i>
                <p>Cine Nepal</p>
              </div>
            </div>
          </div>
  ...
  <script>
    ...
    async function getApiData() {
      try {
        let res = await fetch("https://moviewatch-atullyamzn.42web.io/movie/unzipit/movie/RestAPI.php")
